...
public class Selenium9 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //Hocu da kliknem na karticu i nasao sam lokator
        ...
        for (int i = 0; i < card.size(); i++) {
            if (card.get(i).getText().equals("Widgets")) {
                ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", card.get(i)); // Morao sam da dodam scroll
                card.get(i).click();
                break;
            }
        }
